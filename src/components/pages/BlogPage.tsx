          ...
          <div className="pt-4 flex flex-col sm:flex-row gap-3">
            <div className="relative flex-1">
              ...
              <input
                ...
                placeholder="Search articles on diet, potassium, fistula care, home dialysis..."
                className="w-full pl-11 pr-4 py-2.5 rounded-xl bg-white border border-slate-200 text-xs sm:text-sm text-slate-800 focus:ring-2 focus:ring-[#005BBD] focus:outline-none"
              />
            </div>
          </div>
            ...
            >
              <div>
                <div className="h-52 relative overflow-hidden bg-slate-100">
                  ...
                  />
                  <div className="absolute top-3 left-3 bg-white/95 backdrop-blur-md px-3 py-1 rounded-full text-xs font-bold text-[#005BBD] shadow-xs">
                    {post.category}
                  </div>
                </div>
              ...
              <div className="p-6 pt-0 border-t border-slate-100 mt-4 flex items-center justify-between text-xs text-slate-500">
                ...
                <span className="text-[#005BBD] font-bold flex items-center gap-1 group-hover:translate-x-1 transition-transform">
            ...
            <div className="p-6 sm:p-10 space-y-6">
              ...
              <div className="pt-4 border-t border-slate-100 flex flex-wrap gap-2">
                {activeArticle.tags.map((t, i) => (
                  <span key={i} className="text-xs px-2.5 py-1 rounded-lg bg-blue-50 text-[#005BBD] font-semibold">
                    #{t}
                  </span>
                ))}
              </div>
              ...
              <div className="p-6 rounded-2xl bg-blue-50 border border-blue-100 flex flex-col sm:flex-row items-center justify-between gap-4">
                <div>
                  <h4 className="font-bold text-slate-900 text-sm">Have specific questions about your kidney health?</h4>
                  <p className="text-xs text-slate-600">Consult one of our senior Nephrologists today.</p>
                </div>
                <button
                  onClick={() => {
                  ...
                  className="px-4 py-2.5 rounded-xl bg-[#005BBD] text-white font-bold text-xs shadow hover:bg-[#004A99] whitespace-nowrap cursor-pointer"
                >
