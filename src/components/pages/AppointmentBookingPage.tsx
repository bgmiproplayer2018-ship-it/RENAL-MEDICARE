        ...
        <div className="bg-white rounded-2xl sm:rounded-3xl border border-slate-200 shadow-2xl p-5 sm:p-10 text-center space-y-6">
          ...
          <div className="space-y-2">
            ...
            <p className="text-xs sm:text-sm text-slate-600 max-w-lg mx-auto">
              Your appointment request has been logged. Our dialysis coordination desk will review your details and confirm your slot.
            </p>
          </div>
          ...
          {/* Patient Booking Confirmation & Automated Reminder Notice */}
          <div className="bg-emerald-50/70 border border-emerald-200/80 rounded-2xl p-4 sm:p-5 text-left max-w-lg mx-auto space-y-2.5 shadow-xs">
            <div className="flex items-center gap-2.5">
              ...
              <div>
                ...
                <span className="text-[11px] text-emerald-700 block">
                  Sent to {confirmedAppointment.phone || confirmedAppointment.mobileNumber} 24 hours prior to session
                </span>
              </div>
            </div>

            <p className="text-xs text-emerald-900/80 leading-relaxed pl-10.5">
              You will automatically receive your clinical confirmation and pre-dialysis preparation checklist (fistula care, fluid limits, and duty nephrologist details) via WhatsApp and Email prior to your session.
            </p>
          </div>
