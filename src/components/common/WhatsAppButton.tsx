...
export const WhatsAppButton: React.FC<WhatsAppButtonProps> = ({
  ...
  return (
    <div className="fixed bottom-20 md:bottom-6 right-4 md:right-6 z-40 flex flex-col items-end pointer-events-none">
      ...
      >
        {/* Glow ring */}
        <span className="absolute -inset-1 rounded-full bg-emerald-400 opacity-40 animate-ping pointer-events-none group-hover:opacity-75"></span>
        
        {/* WhatsApp Icon (SVG for crisp fidelity) */}
        <svg
